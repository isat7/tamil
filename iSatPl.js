...
var grammar = {
    ...
    {"name": "while_loop", "symbols": ["while_loop$string$1", "__", "binary_expression", "_", {"literal":"["}, "_", "while_loop$string$2", "_", "statements", "_", "while_loop$string$3", "_", {"literal":"]"}], "postprocess": 
